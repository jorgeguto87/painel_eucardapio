...
import { LayoutDashboard, ShoppingBag, UtensilsCrossed, MessageCircle, Settings, Ticket } from 'lucide-react'
      ...
      <div className="flex items-center justify-around max-w-lg mx-auto">
        {items.map(({ to, icon: Icon, label }) => (
          <NavLink
            ...
            className={({ isActive }) =>
              `flex flex-col items-center gap-1 py-2 px-2 min-w-[52px] transition-colors ${
